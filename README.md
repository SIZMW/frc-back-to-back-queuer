...
* `<other specifier>`: A specifier indicating the type of record for this match row. For example, `BREAK` indicates that this match row is a break in the schedule, either for lunch, day break, or some other intermission. If this is specified, no other additional information will be provided.
